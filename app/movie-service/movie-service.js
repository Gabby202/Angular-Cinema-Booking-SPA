"use strict";
var Movie = (function () {
    function Movie(id, name, category, address, openingHours, city, county, score, image) {
        this.id = id;
        this.name = name;
...
var MovieService = (function () {
    ...
    MovieService.prototype.getMovies = function () {
        var movies = [
            ...
            new Movie(16, "SOLO", "Action, Adventure", "Above Daveys Pub, Bridge Street, Kilcock", "1pm 4pm 5pm", "Kilcock Theaters", "Kildare", 5.0, "image16.jpg"),
        ];
        return movies;
    };
    return MovieService;
